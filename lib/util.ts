export const HOSTING_CONFIG_KEY = "roomcraft-ai_hosting_config";
...
export const createHostingSlug = () => `roomcraft-ai-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`;
